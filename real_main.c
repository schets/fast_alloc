...
const static size_t alloc_size = 16;
...
int main() {
    ...
    time_call(bench_malloc_tog, "Together malloc");
    time_call(bench_batch, "Batch_test");
    time_call(bench_tog, "Together bench");
    time_call(bench_slab_batch, "Batch slab");
    time_call(bench_slab_tog, "Together slab");
    time_call(bench_slab_nof, "Nofree slab");
    time_call(bench_stack_nof, "Nofree stack");
    free(pointers);
}
